...
//                   {}
//                   <div className="flex items-center space-x-2 p-3 bg-emerald-50 rounded-lg border border-emerald-300 text-emerald-800">
...
// // //     case 'querying':
// // //     case 'uploading':
// // //       return <svg className="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 0012 4.004zm-14.28 11.23a8.001 8.001 0 0011.28 11.28l.582-.582m-15.356-11.23a8.001 8.001 0 00-11.28-11.28l-.582.582" /></svg>;
// // //     case 'error':
// // //       return <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>;
// // //     default:
...
// // //   return (
// // //     <div className="prose prose-blue max-w-none leading-relaxed text-lg text-gray-900 whitespace-pre-wrap">
...
// // //       if (response.ok && data.status === 'success') {
// // //         setStatus('indexed');
// // //         setMessage(`Success! Document indexed in ${data.indexing_duration}.`);
...
// // //       if (response.ok && data.status === 'success') {
// // //         setStatus('success');
// // //         setMessage(`Query complete.`);
// // //         setResults(data);
// // //       } else {
// // //         setStatus('error');
// // //         setMessage(`Query failed: ${data.message || 'Unknown error.'}`);
// // //       }
// // //     } catch {
// // //       setStatus('error');
// // //       setMessage(`Network Error during query.`);
// // //     }
// // //   }, [question]);
...
// // //           <div className="lg:col-span-1 space-y-6">
// // //             <div className={`p-4 rounded-xl border-2 ${statusColor} shadow-lg transition-all flex items-start space-x-3`}>
// // //               <div className="pt-1 flex-shrink-0">{getStatusIcon(status)}</div>
// // //               <div>
// // //                 <p className="text-sm font-extrabold">Status: {status.toUpperCase()}</p>
// // //                 <p className="text-xs mt-1">{message}</p>
// // //                 {documentName && <p className="text-xs mt-2 font-mono break-all opacity-75">Doc: {documentName}</p>}
// // //               </div>
// // //             </div>
...
// // //                 accept=".pdf"
// // //                 onChange={(e) => setFile(e.target.files[0])}
// // //                 className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition-colors focus:outline-none"
// // //               />
// // //               <button
// // //                 onClick={uploadFile}
// // //                 disabled={!file || isProcessing}
...
// // //             <div className="p-6 bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-2xl border border-blue-100 min-h-[220px]">
// // //               <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Generated Answer</h2>
...
// // //               {results && results.final_answer && (
// // //                 <div className="space-y-4">
// // //                   <div className="p-5 bg-white border-2 border-blue-200 rounded-xl shadow-inner max-h-[400px] overflow-y-auto">
// // //                     <TypingAnswer text={results.final_answer} />
// // //                   </div>
...
// // // NOTE: In a real environment, this URL would need to be the actual backend endpoint.
// // // Since we don't have a live backend, this is mock.
// // const API_BASE_URL = 'http://localhost:5000';
...
// //     case 'success':
// //       return (
// //         <svg className={`${iconClass} text-emerald-500`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// //     case 'uploading':
// //       return (
// //         <svg className={`${iconClass} animate-spin text-blue-500`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 0012 4.004zm-14.28 11.23a8.001 8.001 0 0011.28 11.28l.582-.582m-15.356-11.23a8.001 8.001 0 00-11.28-11.28l-.582.582" />
// //         </svg>
// //       );
// //     case 'error':
// //       return (
...
// // const StepVisualization = ({ trace }) => {
// //   // Ensure the trace and steps exist before rendering
// //   if (!trace || !trace.steps) return null;
...
// //   return (
// //     <div className="space-y-4 p-5 border border-gray-200 rounded-xl bg-white shadow-lg">
// //       <h3 className="text-xl font-bold text-gray-800 border-b pb-2 mb-3">Process Trace ({trace.elapsed_time?.overall || 'N/A'})</h3>
// //       <div className="space-y-3">
// //         {/* Render each step */}
// //         {trace.steps.map((step, index) => (
// //           <div key={index} className="flex items-center space-x-4">
...
// //         ))}
// //       </div>
// //       {/* Source Context Snippets Section */}
// //       <h4 className="text-lg font-semibold mt-6 text-gray-700 pt-3 border-t">Source Context Snippets</h4>
// //       <pre className="text-xs p-4 bg-gray-50 border border-gray-100 rounded-lg whitespace-pre-wrap max-h-56 overflow-y-auto font-mono text-gray-600">
// //         {trace.source_context || "Context not available. Check steps for failure details."}
// //       </pre>
...
// // // Typing animation effect for the final answer
// // const TypingAnswer = ({ text }) => {
// //   const [displayed, setDisplayed] = useState('');
...
// //   return (
// //     <div className="prose prose-blue max-w-none leading-relaxed text-lg text-gray-900">
// //       {/* ReactMarkdown is used to correctly render markdown formatting like lists, bold, etc. */}
// //       <ReactMarkdown>{displayed}</ReactMarkdown>
// //     </div>
// //   );
// // };
...
// // const App = () => {
// //   // State for application flow and display
// //   const [status, setStatus] = useState('idle');
// //   const [message, setMessage] = useState('Welcome! Please upload a PDF document to begin indexing.');
// //   const [file, setFile] = useState(null);
// //   const [documentName, setDocumentName] = useState('');
...
// //     // Mock API call since no live backend is available
// //     // Replace with actual fetch logic when a backend is running
// //     try {
// //       // Simulating network delay and response structure
...
// //       console.error(e);
// //       setStatus('error');
// //       setMessage(`Mock Network Error: Could not connect to backend or process data.`);
// //     }
// //   }, [file]);

// //   // Function to handle querying the indexed document
// //   const queryDocument = useCallback(async () => {
// //     if (!question.trim()) {
// //       setMessage("Please enter a question.");
// //       return;
...
// //     // Mock API call for query
// //     try {
// //       // Simulating network delay and structured RAG response
...
// //         json: async () => ({
// //           status: 'success',
// //           final_answer: `Based on the document, the capital expenditure limit for Q4 is **$2.5 million**, as stipulated in the *Financial Operating Guidelines, Section 3.2*. This allocation is primarily reserved for critical infrastructure upgrades and cannot be used for operational expenses or staffing.`,
// //           elapsed_time: { overall: '4.8s' },
// //           steps: [
// //             { name: "Retrieve relevant chunks", duration: "1.2s", status: "Completed" },
// //             { name: "Contextual grounding", duration: "2.1s", status: "Completed" },
// //             { name: "LLM generation & summarization", duration: "1.5s", status: "Completed" },
// //           ],
// //           source_context: "The capital expenditure budget for the final quarter (Q4) is strictly capped at $2,500,000. These funds are designated solely for infrastructure improvements (e.g., server farm expansion, office restructuring) and must not be reallocated for personnel or general operating costs. [Page 15, Para 2]"
// //         })
// //       };
...
// //       if (response.ok && data.status === 'success') {
// //         setStatus('success');
// //         setMessage(`Query complete. Elapsed time: ${data.elapsed_time.overall}`);
// //         setResults(data);
// //       } else {
// //         setStatus('error');
// //         setMessage(`Query failed: ${data.message || 'Unknown error.'}`);
...
// //       console.error(e);
// //       setStatus('error');
// //       setMessage(`Mock Network Error during query.`);
// //     }
// //   }, [question]);

// //   // Dynamic styling for the status card
// //   const statusColor = useMemo(() => {
// //     switch (status) {
// //       case 'indexed':
// //       case 'success':
...
// //                 onClick={uploadFile}
// //                 disabled={!file || isProcessing}
// //                 className="mt-4 w-full px-4 py-2 bg-blue-600 text-white font-bold rounded-lg shadow-lg hover:bg-blue-700 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.01]"
// //               >
// //                 {status === 'uploading' ? 'Indexing...' : 'Upload & Index'}
// //               </button>
// //             </div>
...
// //                 placeholder="E.g., What is the capital expenditure limit for Q4?"
// //                 rows="3"
// //                 className="w-full p-3 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 resize-none transition-shadow focus:shadow-md disabled:bg-gray-50"
// //                 disabled={status !== 'indexed' && status !== 'success'}
// //               />
// //               <button
// //                 onClick={queryDocument}
// //                 disabled={(status !== 'indexed' && status !== 'success') || isProcessing || !question.trim()}
// //                 className="mt-4 w-full px-4 py-2 bg-purple-600 text-white font-bold rounded-lg shadow-lg hover:bg-purple-700 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.01]"
// //               >
// //                 {status === 'querying' ? 'Generating Answer...' : 'Generate Answer'}
// //               </button>
// //             </div>
...
// //                     <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
// //                   </svg>
// //                   <p className="font-semibold text-lg mt-3">Processing query and generating response...</p>
// //                 </div>
// //               )}

// //               {/* Successful Results */}
// //               {results && results.final_answer && results.status !== 'error' && (
// //                 <div className="space-y-4">
// //                   <div className="p-5 bg-white border-2 border-blue-200 rounded-xl shadow-inner max-h-[400px] overflow-y-auto">
// //                     <TypingAnswer text={results.final_answer} />
// //                   </div>
